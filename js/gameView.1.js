...
let View = function() {
    ...
    this.itemCards = document.getElementsByClassName("item-card");
...
View.prototype.updateCard = function(id, number)
{
    if (undefined != number) {
        ...
        this.itemCards[id].style.boxShadow = "1px 1px 30px 5px green"; 
        this.successSound.play();
    }
    else {
        this.failSound.play();
        this.itemCards[id].style.boxShadow = "1px 1px 30px 5px red"; 
    }
}
View.prototype.updateCards = function(cardsInfo)
{
    ...
    for (i = 0; i < this.cards.length; ++i) {
        ...
        this.itemCards[i].style.boxShadow = "none"; 
    } 
